                ...
                <div class="w3_login">
                    ...
                    <div class="w3_login_module">
                        <div class="module form-module">
                            ...
                            <a href="index.php" style="float:right;text-decoration:underline;">Login</a>
                            <div class="form">
                                <h2>Create Account Here</h2>
                                <form action="#" method="post" name="form1">
                                    <input class="form-control" type="text" name="f1" placeholder="Enter Patient Id" required=" ">
                                    
                                    
                                    <input class="form-control" type="text" name="f2" placeholder="Enter Patient Name" required=" ">
                                    
                                    <input class="form-control" type="text" name="f3" placeholder="Enter Patient Mobile Number" required=" ">
                                    
                                    
                                    <input class="form-control" type="text" name="f4" placeholder="Enter Patient Email" required=" ">
                                    
                                    
                                    
                                    <input class="form-control" type="text" name="f5" placeholder="Enter Patient Address" required=" ">
                                    
                                    
                                    
                                    
                                    <input class="form-control" type="f6" name="f6" placeholder="Password" required=" ">
